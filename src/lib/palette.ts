...
const WAYPOINTS: PaletteWaypoint[] = [
  ...
  },
  {
    ...
    tokens: {
      ink: [0.09, 0.004, 350],
      paper: [0.962, 0.003, 350],
      muted: [0.6, 0.006, 350],
      accent: [0.9, 0.025, 350],
      surge: [0.69, 0.014, 175],
      laffy: [0.72, 0.012, 350],
    },
  },
  {
    at: 0.46,
    tokens: {
      ink: [0.105, 0.011, 350],
      paper: [0.962, 0.008, 350],
      muted: [0.61, 0.018, 350],
      accent: [0.79, 0.07, 350],
      surge: [0.71, 0.04, 175],
      laffy: [0.78, 0.04, 350],
    },
  },
  {
    ...
    tokens: {
      ink: [0.125, 0.021, 350],
      paper: [0.965, 0.014, 350],
      muted: [0.63, 0.038, 348],
      accent: [0.71, 0.12, 350],
      surge: [0.735, 0.075, 174],
      laffy: [0.815, 0.075, 348],
    },
  },
  {
    at: 0.9,
